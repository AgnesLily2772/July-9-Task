  ...
  return (
    ...
    <ul  className="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a className="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
            ...
            <FontAwesomeIcon style={{marginRight: '10px'}} icon={faLaughWink} />
            </div>
        ...
        <li className="nav-item">
            <a className="nav-link collapsed" href="#!" data-toggle="collapse" data-target="#collapseUtilities"
                ...
                <FontAwesomeIcon style={{marginRight: '10px'}} icon={faWrench} />
                <span>Utilities</span>
            </a>
        ...
        <li className="nav-item">
            <a className="nav-link collapsed" href="#!" data-toggle="collapse" data-target="#collapsePages"
                ...
                <FontAwesomeIcon style={{marginRight: '10px'}} icon={faFolder} />
                <span>Pages</span>
            </a>
        ...
        <li className="nav-item">
            ...
            <FontAwesomeIcon style={{marginRight: '10px'}} icon={faChartArea} />
                <span>Charts</span></a>
        </li>
        ...
        <li className="nav-item">
            ...
            <FontAwesomeIcon style={{marginRight: '10px'}} icon={faTable} />
                <span>Tables</span></a>
        </li>
